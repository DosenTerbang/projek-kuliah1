...
@section('container')
    ...
    <section class="relative -top-5 z-10 flex justify-end pr-5 text-slate-900 md:-top-7">
        <div
            class="animate__animated animate__zoomIn mr-3 flex items-center rounded-md bg-blue-200 px-3 py-2 text-slate-700 shadow-lg shadow-black/30 md:mr-8 md:rounded-xl md:px-5 md:py-3">
        ...
        <div
            class="animate__animated animate__zoomIn animate__delay-1s flex items-center rounded-md bg-blue-200 px-3 py-2 text-slate-700 shadow-lg shadow-black/30 md:rounded-xl md:px-5 md:py-3">
            ...
            <div class="">
                ...
                <p class="text-[8px] md:text-xs"><a href="mailto:rumkitbhykendari@gmail.com"
                        class="text-[8px] hover:text-green-700 md:text-xs">dishubkonsel.kab@gmail.com</a></p>
            </div>
        </div>
    </section>
    ...
    <section class="mt-5">
        <div class="relative mb-12 flex items-center justify-center" data-aos="fade-right">
            ...
            <h2 class="text-center text-3xl font-bold">Bidang</h2>
